...
/**
 * GUI.java
 * GUI displays instructions, register file, and memory file intuitively
 */
...
public class GUI {
	 ...
	 * @param model
	 */
	public void setInstructionList(ListModel model){
	 ...
	 * @param model
	 */
	public void setRegisterList(ListModel model){
	 ...
	 * @param model
	 */
	public void setMemoryList(ListModel model){
